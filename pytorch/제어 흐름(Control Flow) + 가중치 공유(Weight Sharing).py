...
class DynamicNet(torch.nn.Module):
    ...
    def forward(self, x):
        ...
        정희할 때 반복문이나 조건문과 같은 일반적인 Python 제어 흐름 연산자를 사용할
        수 있습니다.
...
# 입력과 출력을 저장하기 위해 무작위 값을 갖는 Tensor 를 생성합니다.
...
# 손실함수와 Optimizerf를 만듭니다. 이 이상한 모델을 순수한 확률적 경사 하강법
# (stoohastic gradiennt decent)으로 학습하는 것은 어려우므로, 모멘텀(momentum)을
# 사용합니다.
